...
//Time Complexity :  O(nm + km) where n is the total number of strings in s1 and s2 arrays, m is the length of the longest string in s1, and k is the length of the longest string in s2
//Space Complexity :  O(nm + km) where n is the total number of strings in s1 and s2 arrays, m is the length of the longest string in s1, and k is the length of the longest string in s2
